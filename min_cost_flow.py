...
class MinCostFlow:
    ...
    def __init__(self, nodesfile, arcsfile):
        ...
        self.node_data = pandas.read_csv('/content/drive/MyDrive/Colab Notebooks/Tarea 11 optimización/nodes.csv')
        self.node_data.set_index(['Node'], inplace=True)
        self.node_data.sort_index(inplace=True)
        # Read in the arcs file
        self.arc_data = pandas.read_csv('/content/drive/MyDrive/Colab Notebooks/Tarea 11 optimización/arcs.csv')
...
if __name__ == '__main__':
       sp = MinCostFlow('/content/drive/MyDrive/Colab Notebooks/Tarea 11 optimización/nodes.csv', '/content/drive/MyDrive/Colab Notebooks/Tarea 11 optimización/arcs.csv') 
       sp.solve()
       print('\n\n---------------------------')
       print('Cost: ', sp.m.OBJ())